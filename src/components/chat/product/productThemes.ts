...
export const PRODUCT_THEMES: Record<ProductChatTheme, ThemeStyles> = {
  classic: {
    ...
    benefitsBtn: 'border border-[#423e3e] bg-[#2c2a2a] hover:bg-[#FBBF24]/10 hover:border-[#FBBF24]/60 text-zinc-100 hover:text-[#FBBF24] rounded-xl hover:shadow-[0_0_12px_rgba(251,191,36,0.15)] transition-all duration-200',
    specsBtn: 'border border-[#423e3e] bg-[#2c2a2a] hover:bg-[#FBBF24]/10 hover:border-[#FBBF24]/60 text-zinc-100 hover:text-[#FBBF24] rounded-xl hover:shadow-[0_0_12px_rgba(251,191,36,0.15)] transition-all duration-200',
  ...
  linear_dark: {
    ...
    benefitsBtn: 'border border-white/[0.08] bg-[#181B1D] hover:bg-[#FBBF24]/10 hover:border-[#FBBF24]/60 text-zinc-300 hover:text-[#FBBF24] rounded-xl hover:shadow-[0_0_12px_rgba(251,191,36,0.15)] transition-all duration-200',
    specsBtn: 'border border-white/[0.08] bg-[#181B1D] hover:bg-[#FBBF24]/10 hover:border-[#FBBF24]/60 text-zinc-300 hover:text-[#FBBF24] rounded-xl hover:shadow-[0_0_12px_rgba(251,191,36,0.15)] transition-all duration-200',
