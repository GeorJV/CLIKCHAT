...
interface ProductOriginalMetricsProps {
  product: Product;
}

export const ProductOriginalMetrics: React.FC<ProductOriginalMetricsProps> = ({ product }) => {
  ...
  return (
    <div className="space-y-2.5">
      {/* Clics compra, Vistas ficha, Beneficios */}
