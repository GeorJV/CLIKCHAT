...
export const PRODUCT_THEMES: Record<ProductChatTheme, ThemeStyles> = {
  classic: {
    ...
    benefitsBtn: 'bg-gradient-to-r from-[#FFB800] to-[#FFA000] hover:from-[#FFA800] hover:to-[#FF9500] text-zinc-950 font-black border border-[#FFA000]/50 rounded-xl shadow-md hover:shadow-lg hover:shadow-amber-500/20 transition-all duration-200',
    specsBtn: 'bg-gradient-to-r from-[#FFB800] to-[#FFA000] hover:from-[#FFA800] hover:to-[#FF9500] text-zinc-950 font-black border border-[#FFA000]/50 rounded-xl shadow-md hover:shadow-lg hover:shadow-amber-500/20 transition-all duration-200',
