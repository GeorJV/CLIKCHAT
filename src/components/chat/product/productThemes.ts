...
export const PRODUCT_THEMES: Record<ProductChatTheme, ThemeStyles> = {
  classic: {
    ...
    botBubble: 'bg-[#2c2a2a] border border-[#423e3e] text-zinc-100 rounded-2xl rounded-tl-xs shadow-lg shadow-black/60',
    userBubble: 'bg-[#D79F4C]/50 backdrop-blur-md border border-[#D79F4C]/40 text-white rounded-2xl rounded-tr-xs font-medium shadow-sm',
  ...
  linear_dark: {
    ...
    botBubble: 'bg-[#2A2E31]/95 backdrop-blur-md border border-white/[0.12] text-[#F1F5F9] rounded-2xl rounded-tl-xs shadow-lg shadow-black/60',
    userBubble: 'bg-[#D79F4C]/50 backdrop-blur-md border border-[#D79F4C]/40 text-white rounded-2xl rounded-tr-xs font-medium shadow-sm',
