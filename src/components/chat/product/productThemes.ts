...
export const PRODUCT_THEMES: Record<ProductChatTheme, ThemeStyles> = {
  classic: {
    ...
    userBubble: 'bg-[#2c2a2a]/65 backdrop-blur-md border border-[#423e3e]/80 text-[#D7BA7D] rounded-2xl font-medium shadow-md',
  ...
  linear_dark: {
    ...
    userBubble: 'bg-[#2A2E31]/65 backdrop-blur-md border border-white/[0.12] text-[#D7BA7D] rounded-2xl font-medium shadow-md',
