...
import { BrainCircuit, BarChart3, Eye, FileSpreadsheet, MessageCircle, Sparkles, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <section id="capacidades" className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div id="autoaprendizaje" className="md:col-span-2 p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-zinc-900 via-zinc-900 to-indigo-950/40 border border-indigo-500/30 space-y-4 relative overflow-hidden">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="p-2.5 rounded-xl bg-indigo-500/20 text-indigo-400 border border-indigo-500/30">
                <BrainCircuit className="w-5 h-5" />
              </div>
              <span className="text-xs font-bold text-indigo-300 uppercase tracking-wider">Auto-Aprendizaje Continuo (HITL)</span>
            </div>
            <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-indigo-500/20 text-indigo-300">Cero Inventos</span>
          </div>
          ...
          <div className="p-3.5 rounded-2xl bg-black/60 border border-indigo-500/20 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
            <div className="flex items-center gap-2 text-zinc-300">
              <span className="w-2 h-2 rounded-full bg-amber-400 animate-ping" />
              <span>Duda no resuelta detectada</span>
            </div>
            <span className="text-indigo-400 font-mono text-[11px] font-bold">➔ Tu respuesta guardada en D1 ➔ Aprendido en 1.5s</span>
          </div>
        </div>

        {/* BENTO 2: Métricas Reales por Clic */}
        <div id="metricas" className="p-6 sm:p-8 rounded-3xl bg-zinc-900/80 border border-white/[0.08] space-y-4">
          <div className="p-2.5 rounded-xl bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 w-fit">
          ...
          <div className="pt-2 border-t border-zinc-800 text-[11px] font-mono text-emerald-400 flex items-center gap-1.5">
            <CheckCircle2 className="w-3.5 h-3.5" /> Métricas sin cookies invasivas
          </div>
        </div>

        {/* BENTO 3: Monitoreo en Vivo e Intervención */}
        <div className="p-6 sm:p-8 rounded-3xl bg-zinc-900/80 border border-white/[0.08] space-y-4">
